...
from transformers import AutoModelForSeq2SeqLM, AutoTokenizer as SummarizationTokenizer  # New imports for summarization
import evaluate
...
def prepare_dataset_nli(examples, tokenizer, max_length):
    # Summarize each premise before tokenizing
    examples['premise'] = [summarize_premise(premise) for premise in examples['premise']]
    
    # Tokenize summarized premises and hypotheses
